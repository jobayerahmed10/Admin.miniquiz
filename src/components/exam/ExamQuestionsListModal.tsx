...
export const ExamQuestionsListModal: React.FC<ExamQuestionsListModalProps> = ({
  ...
  const questions: Question[] = exam.questions && exam.questions.length > 0
    ...
    : [
        {
          id: `${exam.id}-Q1`,
          question: 'নমুনা প্রশ্ন: এই মডেল টেস্টের অন্তর্ভুক্ত প্রথম প্রশ্ন।',
          option_a: 'অপশন ক',
          option_b: 'অপশন খ (সঠিক)',
          option_c: 'অপশন গ',
          option_d: 'অপশন ঘ',
          correct_answer: 'option_b',
          explanation: 'ব্যাখ্যা বিবরণী।',
          status: 'published',
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 truncate max-w-xs">
                  {exam.title} ({questions.length} / {exam.question_count} টি প্রশ্ন)
                </p>
              </div>
            </div>
            <button
