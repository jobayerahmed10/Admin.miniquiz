...
export const INITIAL_SUBJECT_POSTS: SubjectPost[] = [
  ...
  },
  {
    ...
    created_at: new Date().toISOString(),
    topics: [
      { id: 'top-blit-1', name: 'বাংলা সাহিত্যের প্রাচীন যুগ', description: 'চর্যাপদ, চর্যাপদের পদকর্তা ও অন্যান্য', order_index: 1 },
      { id: 'top-blit-2', name: 'বাংলা সাহিত্যের মধ্যযুগ', description: 'শ্রীকৃষ্ণকীর্তন, মঙ্গলকাব্য, বৈষ্ণব পদাবলি, লোক সাহিত্য ও অনুবাদ', order_index: 2 },
      { id: 'top-blit-3', name: 'বাংলা সাহিত্যের আধুনিক যুগ', description: 'কাব্য, গদ্যের বিকাশ, পত্রিকা-সাময়িকী, মুক্তিযুদ্ধভিত্তিক সাহিত্য ও বিশিষ্ট লেখকবৃন্দ', order_index: 3 },
      { id: 'top-blit-4', name: 'পিএসসির নির্ধারিত ১১ জন সাহিত্যিক', description: 'রবীন্দ্রনাথ, নজরুল, বিদ্যাসাগর, মধুসূদন, বঙ্কিম, জসীম উদ্দীনসহ ১১ জন', order_index: 4 },
      { id: 'top-blit-5', name: 'বাংলা সাহিত্যের পঞ্চপাণ্ডব', description: 'জীবনানন্দ দাশ, বুদ্ধদেব বসু, অমিয় চক্রবর্তী, সুধীন্দ্রনাথ দত্ত, বিষ্ণু দে', order_index: 5 },
      { id: 'top-blit-6', name: 'গুরুত্বপূর্ণ নারী লেখক', description: 'বেগম রোকেয়া, সুফিয়া কামাল, সেলিনা হোসেনসহ অন্যান্য নারী লেখক', order_index: 6 },
    ],
  },
  {
    id: 'bangla_language',
    ...
    created_at: new Date().toISOString(),
    topics: [
      { id: 'top-blang-1', name: 'অর্থ তত্ত্ব', description: 'বাগধারা, পারিভাষিক শব্দ, সমার্থক, বিপরীতার্থক ও প্রায় সমোচ্চারিত শব্দ', order_index: 1 },
      { id: 'top-blang-2', name: 'ভাষাতত্ত্ব', description: 'বাংলা ব্যাকরণের ইতিহাস, উৎপত্তি-বিকাশ, ভাষা রীতি ও আলোচ্য বিষয়', order_index: 2 },
      { id: 'top-blang-3', name: 'ধ্বনিতত্ত্ব', description: 'ধ্বনি ও বর্ণ, উচ্চারণ, পরিবর্তন, ণ-ত্ব ও ষ-ত্ব বিধান এবং সন্ধি', order_index: 3 },
      { id: 'top-blang-4', name: 'রূপ তত্ত্ব', description: 'শব্দভাণ্ডার, ধাতু-প্রত্যয়, লিঙ্গ, সংখ্যা, বচন, সমাস ও উপসর্গ', order_index: 4 },
      { id: 'top-blang-5', name: 'পদ-প্রকরণ', description: 'বিশেষ্য, বিশেষণ, সর্বনাম, অব্যয়, ক্রিয়াপদ, কাল ও অনুসর্গ', order_index: 5 },
      { id: 'top-blang-6', name: 'বাক্য প্রকরণ', description: 'বাক্য ও উক্তি, কারক-বিভক্তি, বাচ্য, যতিচিহ্ন, এক কথায় প্রকাশ ও বাক্যশুদ্ধি', order_index: 6 },
    ],
  },
  {
    ...
    created_at: new Date().toISOString(),
    topics: [
      { id: 'top-elit-1', name: 'Anglo-Saxon and Middle English Period', description: 'Beowulf, Geoffrey Chaucer, Old & Middle English literary works', order_index: 1 },
      { id: 'top-elit-2', name: 'The Renaissance Period', description: 'Elizabethan, Jacobean, Caroline and Commonwealth periods', order_index: 2 },
      { id: 'top-elit-3', name: 'The Neo-Classical Period', description: 'Restoration, Augustan Age, and Age of Sensibility/Johnson', order_index: 3 },
      { id: 'top-elit-4', name: 'The Romantic Period', description: 'Wordsworth, Coleridge, Keats, Shelley, Byron, Jane Austen & others', order_index: 4 },
      { id: 'top-elit-5', name: 'The Victorian Period', description: 'Robert Browning, Charles Dickens, Marx, Oscar Wilde, Thomas Hardy, Tennyson', order_index: 5 },
      { id: 'top-elit-6', name: 'Modern Period', description: 'G. B Shaw, Rudyard Kipling, W. B Yeats, T. S Eliot, Hemingway, Woolf, Forster', order_index: 6 },
      { id: 'top-elit-7', name: 'Post Modern Period (1939 — Present)', description: 'George Orwell, Samuel Beckett, Harold Pinter and contemporary authors', order_index: 7 },
      { id: 'top-elit-8', name: "Other Country's Literature", description: 'French, Irish, Scottish, American, Russian, South Asian literature', order_index: 8 },
      { id: 'top-elit-9', name: 'Literary Terms and Genres', description: 'Metaphor, Simile, Irony, Tragedy, Comedy, Epic, Soliloquy, etc.', order_index: 9 },
      { id: 'top-elit-10', name: 'Characters and Quotations', description: 'Famous literary characters, iconic quotations and immortal dialogues', order_index: 10 },
      { id: 'top-elit-11', name: 'Literary Periods, Title and Titles', description: 'Sub-periods, author pen names, titles and sobriquets', order_index: 11 },
      { id: 'top-elit-12', name: 'Poetry/Poems', description: 'Famous English poems, sonnets, elegies, odes and ballads', order_index: 12 },
      { id: 'top-elit-13', name: 'Drama/Play', description: 'Classical and modern tragedies, comedies, historical plays and tragicomedies', order_index: 13 },
      { id: 'top-elit-14', name: 'Novel/Story', description: 'Picaresque, Gothic, Victorian, stream of consciousness novels and short stories', order_index: 14 },
    ],
  },
  {
    id: 'english_grammar',
    ...
    code: 'ENG-GRM',
    tagline: 'Complete Grammar, Usage & Correction',
    badge: 'English Grammar',
    subtitle: '19 Topics & 23 Sub-Topics for BCS & Competitive Exams',
    description: 'Comprehensive English grammar syllabus with all 19 main topics and 23 specialized sub-topics.',
    theme_color: '#6366F1',
    gradient_class: 'bg-gradient-to-br from-indigo-500 via-indigo-600 to-purple-700 shadow-indigo-500/25',
    ...
    created_at: new Date().toISOString(),
    topics: [
      { id: 'top-egrm-1', name: 'Articles', description: 'A, An, The & Omission of Articles', order_index: 1 },
      { id: 'top-egrm-2', name: 'Sentence Correction', description: 'Pinpoint error and sentence correction', order_index: 2 },
      { id: 'top-egrm-3', name: 'Proverbs', description: 'Proverbs and idioms', order_index: 3 },
      { id: 'top-egrm-4', name: 'Subject-Verb-Agreement', description: 'Rules of agreement between subject and verb', order_index: 4 },
      { id: 'top-egrm-5', name: 'Difference Between Words', description: 'Confusing words and proper usage', order_index: 5 },
      { id: 'top-egrm-6', name: 'Parts of Speech', description: 'Adjective, Preposition, Noun, Pronoun, Verb, Adverb, Conjunction & Interjection', order_index: 6 },
      { id: 'top-egrm-7', name: 'Idioms and Phrases', description: 'Idioms and classification of phrases', order_index: 7 },
      { id: 'top-egrm-8', name: 'DERIVATIVES', description: 'Word derivation and roots', order_index: 8 },
      { id: 'top-egrm-9', name: 'Tense', description: 'Tenses and sequence of tenses', order_index: 9 },
      { id: 'top-egrm-10', name: 'GROUP VERB/PHRASAL VERB', description: 'Phrasal and group verbs', order_index: 10 },
      { id: 'top-egrm-11', name: 'Conditional Sentence', description: 'Conditionals and subjunctive', order_index: 11 },
      { id: 'top-egrm-12', name: 'Vocabulary or Words', description: 'Word meaning, spelling, synonyms, antonyms, prefix, suffix, substitution', order_index: 12 },
      { id: 'top-egrm-13', name: 'Clause', description: 'Noun, Adjective & Adverbial clauses', order_index: 13 },
      { id: 'top-egrm-14', name: 'Voice, Narration and Degree', description: 'Voice change, Narration, Degree of comparison', order_index: 14 },
      { id: 'top-egrm-15', name: 'Fill in the Blanks', description: 'Grammatical and contextual fill in the blanks', order_index: 15 },
      { id: 'top-egrm-16', name: 'Composition', description: 'Letters, applications, paragraph related', order_index: 16 },
      { id: 'top-egrm-17', name: 'Miscellaneous [Punctuation, Letter writing, etc.]', description: 'Punctuation, capitalization, letter writing', order_index: 17 },
      { id: 'top-egrm-18', name: 'WH Question & Embedded Question', description: 'Question formation and embedded questions', order_index: 18 },
      { id: 'top-egrm-19', name: 'Sentence and Transformation', description: 'Simple, complex, compound, translation, assertive, tag question', order_index: 19 },
    ],
  },
  {
    id: 'english_language',
    ...
    created_at: new Date().toISOString(),
    topics: [
      { id: 'top-elang-1', name: 'Parts of Speech & Classification', description: 'Nouns, Pronouns, Adjectives, Adverbs, Conjunctions, Articles & Gender', order_index: 1 },
      { id: 'top-elang-2', name: 'Verbs, Tenses & Agreement', description: 'Finite/Non-Finite, Modals, Right Forms of Verbs, Subject-Verb Agreement & Conditionals', order_index: 2 },
      { id: 'top-elang-3', name: 'Voice Change, Narration & Modifiers', description: 'Active/Passive Voice, Direct/Indirect Narration, Modifiers & Tag Questions', order_index: 3 },
      { id: 'top-elang-4', name: 'Clauses, Phrases & Transformation', description: 'Noun/Adjective/Adverbial Clauses & Phrases, Simple/Complex/Compound', order_index: 4 },
      { id: 'top-elang-5', name: 'Preposition, Idioms & Phrasal Verbs', description: 'Appropriate Prepositions, Idioms & Phrases, Group Verbs', order_index: 5 },
      { id: 'top-elang-6', name: 'Vocabulary, Spelling & Correction', description: 'Synonyms, Antonyms, One Word Substitution, Analogy, Spelling & Pinpoint Errors', order_index: 6 },
    ],
  },
  {
    ...
    created_at: new Date().toISOString(),
    topics: [
      { id: 'top-math-1', name: 'পাটিগণিত', description: 'বাস্তব সংখ্যা, লাভ-ক্ষতি, শতকরা, মুনাফা, লসাগু-গসাগু, অনুপাত, ঐকিক নিয়ম ও গতিবেগ', order_index: 1 },
      { id: 'top-math-2', name: 'বীজগণিত', description: 'সূত্রাবলি, উৎপাদক, সমীকরণ, অসমতা, সূচক-লগারিদম, ধারা, সেট ও বিন্যাস-সমাবেশ', order_index: 2 },
      { id: 'top-math-3', name: 'জ্যামিতি', description: 'রেখা, কোণ, বৃত্ত, ত্রিভুজ, চতুর্ভুজ, পিথাগোরাস, ত্রিকোণমিতি ও পরিমিতি', order_index: 3 },
    ],
  },
  {
    id: 'general_science',
  ...
  },
  {
    ...
    created_at: new Date().toISOString(),
    topics: [
      { id: 'top-bd-1', name: 'জাতীয় বিষয়াবলি', description: 'মুক্তিযুদ্ধ, ইতিহাস, জুলাই অভ্যুত্থান, বীরশ্রেষ্ঠ ও জাতীয় বিষয়াদি', order_index: 1 },
      { id: 'top-bd-2', name: 'কৃষিজ সম্পদ', description: 'মৎস্য, প্রাণী, ফসলের জাত, উৎপাদন ও কৃষি বিষয়াবলি', order_index: 2 },
      { id: 'top-bd-3', name: 'সংস্কৃতি ও প্রত্নস্থল', description: 'বাঙালির সংস্কৃতি, শিল্পকলা ও প্রত্নস্থল', order_index: 3 },
      { id: 'top-bd-4', name: 'বৈদেশিক সম্পর্ক', description: 'আন্তর্জাতিক অঙ্গনে বাংলাদেশ, দ্বিপাক্ষিক ও আঞ্চলিক সম্পর্ক', order_index: 4 },
      { id: 'top-bd-5', name: 'ভূ-প্রকৃতি, পরিবেশ ও দুর্যোগ', description: 'ভূ-প্রকৃতি, বন, পরিবেশ, জলবায়ু ও দুর্যোগ ব্যবস্থাপনা', order_index: 5 },
      { id: 'top-bd-6', name: 'অর্থনীতি', description: 'দারিদ্র্য বিমোচন, প্রাকৃতিক সম্পদ, খাতসমূহ ও আর্থিক প্রতিষ্ঠান', order_index: 6 },
      { id: 'top-bd-7', name: 'শিল্প ও বাণিজ্য', description: 'শিল্প মন্ত্রণালয়, উৎপাদন, আমদানি-রপ্তানি', order_index: 7 },
      { id: 'top-bd-8', name: 'যোগাযোগ, শিক্ষা, স্বাস্থ্য ও তথ্যপ্রযুক্তি', description: 'যোগাযোগ, বিজ্ঞান প্রযুক্তি, শিক্ষা ও স্বাস্থ্যসেবা', order_index: 8 },
      { id: 'top-bd-9', name: 'জনগোষ্ঠী ও জনসংখ্যা', description: 'আদমশুমারি, জনসংখ্যা ও ক্ষুদ্র নৃগোষ্ঠী', order_index: 9 },
      { id: 'top-bd-10', name: 'সংবিধান', description: 'ইতিহাস, অনুচ্ছেদ, তফসিল ও সংশোধনীসমূহ', order_index: 10 },
      { id: 'top-bd-11', name: 'রাজনৈতিক ব্যবস্থা', description: 'নির্বাচন কমিশন, রাজনৈতিক দল ও ব্যক্তিত্ব', order_index: 11 },
      { id: 'top-bd-12', name: 'সরকার ব্যবস্থা', description: 'প্রশাসনিক কাঠামো, সংসদ, নির্বাহী ও বিচার বিভাগ', order_index: 12 },
      { id: 'top-bd-13', name: 'জাতীয় অর্জন ও অন্যান্য', description: 'খেলাধুলা, চলচ্চিত্র, পুরস্কার, পদক ও জাতীয় স্থাপনা', order_index: 13 },
      { id: 'top-bd-14', name: 'অর্থনৈতিক সমীক্ষা ও বাজেট', description: 'অর্থনৈতিক সমীক্ষা, বাজেট ও অন্যান্য প্রতিবেদন', order_index: 14 },
    ],
  },
  {
